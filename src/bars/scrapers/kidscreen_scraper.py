...
Scrapes kids entertainment industry news from Kidscreen.com with improved
...
ARTICLE_CONTAINER_SELECTOR = "#article-container"
TITLE_SELECTORS = [
    "h1.article-title",
    "h1",
    "title"
...
CONTENT_CONTAINER_SELECTOR = "div.article-content"
UNWANTED_SELECTORS = [
    "script", "style", "aside", "figure", "form", ".article-ad", ".related-stories-list", ".article-topics-container"
]
ARTICLE_LINK_SELECTOR = "#main-content .post-info > a"


class KidscreenScraper(BaseScraper):
    """
    Enhanced scraper for Kidscreen.com.
    Uses playwright-stealth to avoid detection.
    """

    def __init__(self, test_mode: bool = False, **kwargs):
        """Initialize the Kidscreen scraper."""
        super().__init__(base_url="https://kidscreen.com", name="kidscreen", **kwargs)
    ...
    async def scrape(self) -> List[Dict]:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await page.goto(self.base_url, wait_until="load", timeout=120000)
                await page.wait_for_load_state("networkidle")
...
async def scrape_kidscreen(test_mode: bool = False, **kwargs) -> List[Dict]:
    """Helper function to run the Kidscreen scraper."""
    scraper = KidscreenScraper(test_mode=test_mode, **kwargs)
...
if __name__ == "__main__":
    ...
    async def main():
        print("🚀 Starting Kidscreen scraper in standalone test mode...")
        scraped_articles = await scrape_kidscreen(test_mode=False)
    ...
    # To run this file directly for testing: python -m scrapers.kidscreen_scraper
    asyncio.run(main())
